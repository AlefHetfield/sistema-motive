...
const statusConfig = {
    ...
    'Fichas e Cadastros': { style: 'bg-teal-50 text-teal-700 border border-teal-100', icon: FileCheck },
...
const statusDotMap = {
    ...
    'Fichas e Cadastros': 'bg-teal-400',
...
const statusBorderMap = {
    ...
    'Fichas e Cadastros': 'border-teal-400',
